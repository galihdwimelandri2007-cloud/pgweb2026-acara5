...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" type="ArcSDE Connection" name="SDE Feature Class" description="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" size="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
